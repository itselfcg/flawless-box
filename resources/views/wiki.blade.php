            ...
            <article id="cleanser">
                ...
                <div class="row center">
                    <div class="col-md-6 col-12 ">
                        ...
                        <h3>CLEANSER</h3>
                        <p>
                            Oil cleansers can also be part of a multiple-step cleansing process to get the “best clean”
                            you
                            can. For
                            example, makeup wearers like to cleanse with oil to remove product and dirt, followed by a
                            foaming
                            cleansing
                        ...
                        <ol>
                            ...
                            <li>Soak a little facial towel in warm water and then press into your face. The heat from
                                the
                                towel
                                will
                            ...
                            <li>Remove lipstick and eye makeup, including mascara, put a couple of drops of oil on damp
                                cotton
                                rounds
                            </li>
                        </ol>
            ...
            <article id="toner" >
                <div class="row center ">
                    ...
                    <div class="col-md-6 col-12 order-md-last order-first">
                        ...
                        <h3>TONER</h3>
                        <p>
                            Toners are often misunderstood and most people don't know if they should use it, or how to
                            use
                            it. Before
                            moisturizing and following your facial cleanser, a face toner is a quick, absorbing liquid
                            that
                            helps to
                            remove excess dirt, traces of oil and makeup, correct and balance the pH of your skin, and
                            control acne.
                            In
                        ...
                        <div>
                            <h5>HOW TO APPLY </h5>
                            <ol>
                                <li> After cleansing, apply a small amount of liquid, alcohol-free facial toner onto a
                                    cotton ball
                                    or
                                    pad.
                                </li>
                ...
                <div class="row center">
                    <div class="col-md-6 col-12 ">
                        ...
                        <div>
                            <h5>HOW TO APPLY </h5>
                            <ol>
                                <li> The amount you need may vary depending on your skin and the particular product you
                                    have.
                                </li>
            ...
            <article id="essence" >
                <div class="row center">
                    ...
                    <div class="col-md-6 col-12 order-md-last order-first">
                        ...
                        <h3>essence</h3>
                        <p>
                            Essences have similar benefits to a serum, and with a lower molecular weight than most daily
                            creams,
                            they
                    ...
                    <div class="col-md-6 col-12 ">
                        ...
                        <div>
                            ...
                            <ol>
                                ...
                                <li>Wet your face with water. Pump 2 or 3 pumps of foaming cleanser into the palms of
                                    your
                                    hands.
                                </li>
            ...
            <article id="eye-cream" >
                <div class="row center ">
                    ...
                    <div class="col-md-6 col-12 order-md-last order-first">
                        ...
                        <p>
                            Eye cream will reduce signs of ageing as long as you apply your product morning and night.
                            Some
                            eye
                            cream
                            help shadows and bags by increasing the circulation and others are better with fine lines
                            and
                            wrinkles.
                            Some
                            eye creams do both. Eye creams are generally thicker than face creams and target the lack of
                            collagen
            ...
            <article id="spot-treatment" >
                <div class="row center">
                    <div class="col-md-6 col-12 ">
                        ...
                        <p>
                            Exfoliating is the process of removing dead skin cells from the surface of your skin using a
                            chemical,
            ...
            <article id="moisturizer" >
                <div class="row center">
                    ...
                    <div class="col-md-6 col-12 order-md-last order-first">
                        ...
                        <h3>Moisturizer</h3>
                        <p>
                            A face moisturizer helps to prevent dryness and moisture loss in skin. A properly formulated
                            moisturiser
                            can
                            deliver long-lasting hydration to help support skin’s natural barrier for protection against
                            external
                        ...
                        <div>
                            <h5>HOW TO APPLY </h5>
                            <ol>
                                <li> After you’ve waited 5 minutes for the serum to absorb, apply your moisturizer to
                                    your
                                    face
                                    and
                                    neck.
                ...
                <div class="row center">
                    <div class="col-md-6 col-12 ">
                        ...
                        <p>
                            ...
                            you from
                            UVB.
                            The British Association of Dermatologists recommend always using a minimum of SPF 30, which
                            blocks 97%
                            of
